...
# 27 "Maestro4EEPROMEUSART.c" 2

# 1 "C:\\Program Files\\Microchip\\xc8\\v2.35\\pic\\include\\c90\\stdint.h" 1 3
# 28 "Maestro4EEPROMEUSART.c" 2
...
# 29 "Maestro4EEPROMEUSART.c" 2
# 47 "Maestro4EEPROMEUSART.c"
uint8_t MODO = 0;
unsigned short POT_1_M;
unsigned short POT_2_M;
uint8_t POT_1;
uint8_t POT_2;
uint8_t POT_3;
uint8_t POT_4;
...
uint8_t POT_3_E;
uint8_t POT_4_E;
uint8_t BANDERA_L1, BANDERA_L2;
uint8_t BANDERA_E1, BANDERA_E2;
uint8_t BANDERA_R;
uint8_t SELECCION_SERVO = 0;
uint8_t VALORPOT_USART;
uint8_t CONT;
uint8_t CONT3;
    ...
    if(PIR1bits.ADIF){
        if(ADCON0bits.CHS == 0){
            if(MODO == 0){
                ...
                POT_1 = ADRESH;
                POT_1_M = map(POT_1, 0, 255, 135, 580);
            }
            else if (MODO == 1){
                if(BANDERA_R == 1){
                    _delay((unsigned long)((1000)*(1000000/4000.0)));
                ...
                POT_1_M = map(POT_1_E, 5, 127, 135, 580);
            }

            CCPR1L = (uint8_t)(POT_1_M>>2);
            CCP1CONbits.DC1B = POT_1_M & 0b11;
            ...
            if(MODO == 0){
                ...
                POT_2 = ADRESH;
                POT_2_M = map(POT_2, 0, 255, 135, 580);
            }
            else if (MODO == 1){
                if(BANDERA_R == 1){
                    _delay((unsigned long)((1000)*(1000000/4000.0)));
                ...
                POT_2_M = map(POT_2_E, 5, 127, 135, 580);
            }

            CCPR2L = (uint8_t)(POT_2_M>>2);
            CCP2CONbits.DC2B0 = POT_2_M & 0b01;
            CCP2CONbits.DC2B1 = (POT_2_M & 0b10)>>1;
        }
