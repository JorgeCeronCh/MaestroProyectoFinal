...
# 27 "Maestro_EEPROM.c" 2

# 1 "C:\\Program Files\\Microchip\\xc8\\v2.35\\pic\\include\\c90\\stdint.h" 1 3
# 28 "Maestro_EEPROM.c" 2
...
# 29 "Maestro_EEPROM.c" 2
# 43 "Maestro_EEPROM.c"
uint8_t MODO = 0;
unsigned short POT_1;
unsigned short POT_2;
uint8_t POT_3;
uint8_t POT_4;
...
void __attribute__((picinterrupt(("")))) isr (void){
    ...
    if(PIR1bits.ADIF){
        ...
        if(ADCON0bits.CHS == 0){
            if(MODO == 0){
                POT_1 = map(ADRESH, 0, 255, 135, 590);
            }
            CCPR1L = (uint8_t)(POT_1>>2);
            CCP1CONbits.DC1B = POT_1 & 0b11;
            ADCON0bits.CHS = 1;
        }
        else if(ADCON0bits.CHS == 1){
            if(MODO == 0){
                POT_2 = map(ADRESH, 0, 255, 135, 590);
            }
            CCPR2L = (uint8_t)(POT_2>>2);
            CCP2CONbits.DC2B0 = POT_2 & 0b01;
            CCP2CONbits.DC2B1 = (POT_2 & 0b10)>>1;
            ADCON0bits.CHS = 2;
        }
