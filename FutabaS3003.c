...
#define OUT_MIN1 135             
#define OUT_MAX1 338             // Valores para el servomotor MG996R ---> en realidad debería de ser 125 y 600 pero se disminuyeron para que giraran casi 180 grados
#define OUT_MIN2 135             
#define OUT_MAX2 580             // Valores para el servomotor MG996R ---> en realidad debería de ser 125 y 600 pero se disminuyeron para que giraran casi 180 grados
...
void __interrupt() isr (void){
    if(PIR1bits.ADIF){                      // Verificación de interrupción del módulo ADC
        if(ADCON0bits.CHS == 0){        // Verificación de canal AN0
            ...
            POT_2 = ADRESH;
            POT_2_M = map(POT_2, IN_MIN, IN_MAX, OUT_MIN2, OUT_MAX2);    // Almacenar el resgitro ADRESH en variable POT2
